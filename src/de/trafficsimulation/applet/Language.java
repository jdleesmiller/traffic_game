...
public class Language {
  ...
  public void setIndex(int i) {
    if (i < 0 || i > CAR_STRING.length) {
      // error ...
      System.err.println("parameter: language index " + i
  ...
  private String[] PROBE_VEH_STRING = { "Testfahrzeug", "Probe Car",
      "Carro de Teste", "Voiture test" };
  ...
  private String[] UPHILL_MARKER = { "Steigung", "uphill", "ladeira",
      "inclinaison" };
  ...
  private String[] UPHILL_MARKER_BEGIN = { "Beginn", "Begin", "Come�o",
      "D\u00E9but" };
  ...
  private String[] DESIRED_VEL = { "Wunschgeschwindigkeit", "Desired Velocity",
      "Velocidade Desejada", "Vitesse souhait\u00E9e" };

  public String getDesiredVelIDM() {
    return DESIRED_VEL[langIndex];
  }

  private String[] DESIRED_HEADWAY = { "Zeitl�cke", "Time gap",
      "Intervalo de tempo", "Intervalle de temps" };

  public String getDesiredHeadwayIDM() {
    return DESIRED_HEADWAY[langIndex];
  }

  private String[] DESIRED_ACC = { "Beschleunigung", "Acceleration",
      "Acelera��o", "Acc\u00E9l\u00E9ration" };

  public String getDesiredAccelIDM() {
    return DESIRED_ACC[langIndex];
  }

  private String[] DESIRED_DECEL = { "Bremsverz�gerung", "Deceleration",
      "Desacelera��o", "D\u00E9c\u00E9l\u00E9ration" };

  public String getDesiredDecelIDM() {
    return DESIRED_DECEL[langIndex];
  }

  private String[] MIN_GAP = { "Abstand im Stau", "Minimum gap",
      "Dist�ncia m�nima", "\u00C9cart minimal" };

  public String getMinGapIDM() {
    return MIN_GAP[langIndex];
  }

  private String[] IDM_S1 = { "Abstand s1", "Distance s1", "Dist�ncia s1",
      "Distance s1" };
  ...
  private String[] AVG_DENSITY = { "Verkehrsdichte", "Average Density",
      "Densidade M�dia", "Densit\u00E9 moyenne" };

  public String getAvgDensity() {
    return AVG_DENSITY[langIndex];
  }

  private String[] INFLOW = { "Haupt-Zufluss", "Main Inflow",
      "Fluxo de entrada Principal", "Flux entrant principal" };

  public String getInflow() {
    return INFLOW[langIndex];
  }

  private String[] RAMP_INFLOW = { "Zufluss der Zufahrt", "Ramp Inflow",
      "Fluxo de entrada Rampa", "Demande de la bretelle d'acc\u00E8s" };

  public String getRampInflow() {
    return RAMP_INFLOW[langIndex];
  }

  private String[] MOBIL_POLITE = { "H�flichkeitsfaktor", "Politeness Factor",
      "Fator de Polidez", "Degr\u00E9 de politesse" };

  public String getMobilPoliteness() {
    return MOBIL_POLITE[langIndex];
  }

  private String[] MOBIL_RAMP_POLIT = { "p-Faktor Zufahrt", "p-factor ramp",
      "Fator-p Rampa", "Coefficient p de la bretelle d'ac\u00E8s" };

  public String getMobilPolitenessRamp() {
    return MOBIL_RAMP_POLIT[langIndex];
  }

  private String[] TRUCK_PERC = { "LKW-Anteil", "Truck Percentage",
      "Porcentagem de Caminh�es", "Proportion de camions" };

  public String getTruckPerc() {
    return TRUCK_STRING[langIndex];
  }

  private String[] MOBIL_THRES = { "Wechselschwelle", "Changing Threshold",
      "Limite de Altera��o", "Limitation de changement de voie" };

  public String getMobilThreshold() {
    return MOBIL_THRES[langIndex];
  }

  private String[] MOBIL_RAMP_BIAS = { "a_bias,Zufahrt", "a_bias,onramp",
      "a_bias,rampa", "a_bias, acc\u00E8s" };

  public String getMobilRampBias() {
    return MOBIL_RAMP_BIAS[langIndex];
  }

  private String[] TIME_WARP = { "Zeitlicher Warp-Faktor", "Time Warp Factor",
      "Fator de Time Warp", "Dilatation temporelle" };
  ...
  private String[] SPEEDLIMIT = { "Tempolimit", "Imposed Speed Limit",
      "Limite de Velocidade", "Limitation de vitesse" };

  public String getSpeedlimit() {
    return SPEEDLIMIT[langIndex];
  }

  private String[] VEH_PER_HOUR = { " Kfz/h", " Vehicles/h", " Ve�culos/h",
      "V\u00E9hicules/h" };
  ...
  private String[] VEH_PER_KM = { " Kfz/km/Spur", " Veh./km/lane",
      " Ve�c./km/pista", "V\u00E9h./km/voie" };
  ...
  private String[] SCEN_RING = { "Ringstra�e", "Ring Road", "Estrada Circular",
      "Circuit" };
  ...
  private String[] SCEN_ONRAMP = { "Zufahrt", "On-Ramp", "Com Rampa",
      "Bretelle d'acc\u00E8s" };
  ...
  private String[] SCEN_LANE_CLOSING = { "Spursperrung", "Laneclosing",
      "Pista fechada", "Voie ferm\u00E9" };

  public String getScenLaneclosingName() {
    return SCEN_LANE_CLOSING[langIndex];
  }

  private String[] SCEN_UPHILL = { "Steigung", "Uphill Grade", "Com Ladeira",
      "Route en pente" };
  ...
  private String[] SCEN_TRAFFIC_LIGHTS = { "Stadtverkehr", "Traffic Lights",
      "Sem�foro", "Feux tricolores" };

  public String getScenTrafficlightsName() {
    return SCEN_TRAFFIC_LIGHTS[langIndex];
  }

  private String[] BUTTON_PERTURBATION = { "Verurache St�rung!",
      "Apply Perturbation!", "Causar Perturba��o!",
