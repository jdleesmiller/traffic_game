...
*/
  ...
  protected MicroStreet microstreet;
   ...
   * 
   * Subclasses can override this in order to be notified every time time step.
   */
  protected void tick() {
  ...
  private void updateCircle(Graphics g, int framesPerStep) {
    ...
    Vector<Color> colors = microstreet.colors;
  ...
  private void prepareVehData() {
    ...
    Vector<Double> positions = microstreet.positions;
    Vector<Integer> numbers = microstreet.numbers;
    Vector<Integer> lanes = microstreet.lanes;
    // Vector colors=microstreet.colors;
    Vector<Double> lengths = microstreet.lengths;
    Vector<Double> old_positions = microstreet.old_pos;
    Vector<Integer> old_lanes = microstreet.old_lanes;
    Vector<Integer> old_numbers = microstreet.old_numbers;
  ...
  /**
   * Return the numeric code for the currently loaded scenario.
   * 
   * @return currently either 1 (ring road) or 2 (onramp)
   */
