...
public class LaneChange implements Constants {
  ...
  private double bsave = MAIN_BSAVE; // maximum safe braking deceleration for
                                     // other vehicles
  private double bsaveSelf = MAIN_BSAVE_SELF; // maximum safe braking
                                              // deceleration for subject
                                              // vehicle
  ...
  public LaneChange(String lctype) {
    if (lctype.equals("truck")) {
      System.out.println("in Cstr LaneChange(''truck''): " + "db=" + db
          + " bsave=" + bsave);
      ...
      System.out.println("in Cstr of LaneChange(''car''): " + "db=" + db
          + " bsave=" + bsave);
    }
  }

  public LaneChange(double p, double db, double gapMin, double bsave,
      double biasRight) {
    this(p, db);
